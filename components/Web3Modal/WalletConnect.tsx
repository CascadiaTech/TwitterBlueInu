    ...
    <div>
      {active ? (
        <button
          ...
          className="text-white bg-gradient-to-r from-blue-700 to-blue-900 hover:from-blue-500 hover:to-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
        >
          Disconnect Wallet
        </button>
      ) : (
        <div>
          <button
            type="button"
            onClick={OnClick}
            className="text-white bg-gradient-to-r from-blue-700 to-blue-900 hover:from-blue-500 hover:to-blue-700 focus:ring-4 focus:ring-blue-300 font-medium mt-2 rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
          >
            Connect Wallet
          </button>
